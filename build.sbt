...
lazy val projectVersion = "3.19.0-SNAPSHOT"
lazy val mimaVersion    = "3.19.0" // used for migration-manager
...
lazy val deps = new {
  val main = new {
    ...
    val lucreSwing          = "1.9.0-SNAPSHOT"
    val model               = "0.3.4"
    val numbers             = "0.1.5"
    val scalaCollider       = "1.26.0-SNAPSHOT"
    val scalaColliderIf     = "0.7.0-SNAPSHOT"
    val swingPlus           = "0.3.0"
    val topology            = "1.1.0"
    val ugens               = "1.18.0"
  }
