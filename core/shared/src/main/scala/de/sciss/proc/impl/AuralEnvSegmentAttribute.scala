...
import de.sciss.proc.AuralAttribute.{Factory, GraphemeAware, Observer}
import de.sciss.proc.impl.AuralAttributeImpl.ExprImpl
import de.sciss.proc.{AuralAttribute, AuralContext, ControlValuesView, EnvSegment, Grapheme, StartLevelViewFactory, TimeRef}
